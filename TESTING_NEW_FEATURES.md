...
**Requires**: Azure OpenAI keys in .env
...
**Where**: Add Booking → Upload PDF with Azure OpenAI configured → ✅ Low-confidence fields highlighted yellow/red
...
**Where**: Azure OpenAI prompt includes carrier-specific document type detection
...
## Azure Features (need .env keys)
| Feature | Works without Azure? |
|---------|---------------------|
